<?php
	...
	add_action( 'abpet_pagination_template', function ( $args = [] ) {
		$total    = $args['total'] ?? 0;
		...
		if ( $total > $per_page ) { ?>
            <div class="pagination_area _all_center">
				<?php if ( $style == 'live' ) { ?>
                    <button type="button" class="_btn_theme_min_200 live_pagination" data-load-more="0"><?php esc_html_e( 'View More', 'abp-event-ticket' ); ?></button>
				...
				<?php } else {
                    ...
                    <label class="_mar_r _max_200">
                        <span class="_mar_r_xs"><?php esc_html_e( 'Showing Item', 'abp-event-ticket' ); ?></span>
                    ...
                    <div class="_group_content">
						<?php if ( $total_page > 1 ) { ?>
                            <button class="_btn_tp_xs" type="button" data-page="<?php echo esc_attr( $page - 1 > 0 ? $page - 1 : $total_page ); ?>" title="<?php esc_attr_e( 'Previous Page', 'abp-event-ticket' ); ?>"><span class="fas fa-angle-left"></span></button>
						<?php }
							...
							<?php }
							if ( $total_page > 1 ) { ?>
                                <button class="_btn_tp_xs" type="button" data-page="<?php echo esc_attr( $page < $total_page ? $page + 1 : 1 ); ?>" title="<?php esc_attr_e( 'Next Page', 'abp-event-ticket' ); ?>"><span class="fas fa-angle-right"></span></button>
							<?php } ?>
                    </div>
				<?php } ?>
            </div>
