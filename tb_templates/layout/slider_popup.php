<?php
	...
	add_action( 'abpet_slider_popup_template', function ( $abpet_slider, $img_ids, $popup_id = '' ) {
		$active_popup = ( $abpet_slider['visible_popup'] ?? 'on' ) ?: 'on';
		$indicator    = ( $abpet_slider['popup_image_indicator'] ?? 'on' ) ?: 'on';
        ...
        <div class="abp_popup" data-popup="<?php echo esc_attr( $popup_id ); ?>">
            <div class="popup_area abpet_slider">
