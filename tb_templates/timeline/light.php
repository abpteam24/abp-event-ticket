<?php
	...
	add_action( 'abpet_timeline_light_template', function ( $timeline_items = [], $post_id = 0 ) {
		if ( empty( $timeline_items ) || ! is_array( $timeline_items ) ) {
			return;
		}
		?>
        <section class="abpet_timeline abpet_timeline_light">
            <div class="_panel_head _fj_between">
                <h4 class="abp"><i class="fas fa-history" aria-hidden="true"></i><?php esc_html_e( 'Event Timeline', 'abp-event-ticket' ); ?></h4>
            </div>
                ...
                <div class="abpet_tl_list">
					<?php foreach ( $timeline_items as $index => $item ) {
                        ...
                        <div class="abpet_tl_item">
                            <div class="abpet_tl_marker">
                                <span class="abpet_tl_marker_core"></span>
                            </div>
