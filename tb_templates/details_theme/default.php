		...
		if ( ! empty( $post_id ) && $post_id > 0 && get_post_type( $post_id ) == ABPET_Function::get_cpt() && ( get_post_status( $post_id ) == 'publish' || is_admin() ) ) {
            ...
            <div id="abpet_area" class="abpet_area default_details_page">
                <div class="abp_container">
                    <div class="_abp_row">
                        <div class="_f_equal_f_wrap_gap_section_15 abpet_intro abpet_default_intro">
                            <div class="abpet_details_column abpet_default_media">
                            ...
                            <div class="abpet_details_column abpet_default_summary">
								...
								<?php if ( ABPET_Function::on_off( 'feature' ) ) {
									...
									if ( $show_date_list ) {
										do_action( 'abpet_event_schedule_list', $post_id, $all_dates, $time_infos, $start_date, $start_time, 'dropdown' );
									} ?>
                            </div>
                        </div>
                    </div>
